...
describe('getAuthorList', () => {
    ...
    it('should display empty string last name is absent', async () => {
        const sortedAuthors = [
            {
                first_name: 'Jane',
                family_name: '',
    ...
    it('should return only birthdate if death date undefined', async () => {
        const sortedAuthors = [
            {
                first_name: 'Jane',
                family_name: 'Austen',
    ...
    it('should return only death date for undefined birthdate', async () => {
        const sortedAuthors = [
            {
                first_name: 'Jane',
                family_name: 'Austen',
